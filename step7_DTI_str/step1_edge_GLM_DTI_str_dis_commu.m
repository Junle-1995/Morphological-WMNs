%% fitlm between str connectivity, dis, commu and structural connectivity
%% the dis and communicability are calculated by averaging individual auc
%% para
roi_num = 48;

load('unrelated_sub_matrix_str_DBM.mat')
str_data = mean(sub_matrix,3);
load('unrelated_sub_matrix_fun.mat')
fun_data = mean(sub_matrix,3);
load('unrelated_sub_bin_dis_str_DBM.mat')
...
%% save
cd(path)
save('Edge_GLM_DTI_str_dis_commu_DBM.mat','results')